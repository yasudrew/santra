      ...
      <section className="relative py-20 sm:py-32 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center space-y-8">
          <div className="space-y-3">
            ...
            <h1 className="text-5xl sm:text-8xl font-black tracking-tight bg-gradient-to-r from-violet-500 via-fuchsia-500 to-rose-500 bg-clip-text text-transparent">
              賛美Tracks.com
            </h1>
      ...
      <footer className="py-8 border-t border-border/40">
        <div className="mx-auto max-w-6xl px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            © 2026 サントラ (Santra). All rights reserved.
          </p>
